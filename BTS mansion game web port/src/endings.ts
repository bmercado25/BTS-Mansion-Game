/**
 * Ending copy from GameControllerClass constructor (C++ string-literal concat).
 * | quote markers match source.
 */

export const GOOD_ENDING = [
  "You instantly fall unconscious, and begin to see the origin story of this mansion...",
...
export const NEUTRAL_ENDING = [
  "The room shudders, all of the candles light up at once and a bright light fills the room with you.",
...
export const BAD_ENDING = [
  "The room goes silent. You stand there waiting for something,",

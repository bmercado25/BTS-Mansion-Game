/**
 * Backstory from GameControllerClass constructor (C++ string-literal concat).
 * Shown line-by-line via waitForInput on START (C++ showMenu → displayBackstory).
 */
export const BACKSTORY = [
  "You step out of the car arriving at the campsite.",
